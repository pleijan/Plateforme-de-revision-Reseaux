...
- Enoncé
L’application web devra permettre aux étudiants débutants d’aborder les notions de réseau vue au semestre 1 sous un angle pédagogique et ludique au travers de possibles animations. L'application WEB classique sera hébergé en intranet et devra contenir divers fonctionnalitées accessible depuis un menu. L'utilisateur entre l'adresse IP dans des champs de texte, et le programme traduit ces Adresses IP décimal en hexadécimal ou binaire et inversement.
