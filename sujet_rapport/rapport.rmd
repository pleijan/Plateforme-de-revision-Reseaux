...
# Conclusion
Toutes les exigences n'ont pour le moment pas été satisfaite. Environ la moitié du travail à été fait. Nous devons acquérir les compétences nécéssaires pour pouvoir continuer le projet.
Nous avons atteint nos objectif c'est à dire programmer toute les fonctionnalité que nous savons faire en attendant de connaitre les autres compétences nécéssaire à la poursuite du projet et livrer un rapport complet.
Notre client, M.Hoguin a mentionné qu'il pouvait y avoir des améliorations.
Ce projet nous permet de consolider nos connaissance en réseau mais aussi en programmation WEB. De plus, ce projet nous apprend à travailler en équipe, et nous apprend a créer un rapport complet et bien structuré.
