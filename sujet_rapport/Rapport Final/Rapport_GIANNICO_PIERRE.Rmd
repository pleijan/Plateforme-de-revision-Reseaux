...
On va créer une échelle pour la probabilité de réalisation d’un risque qui va de 1 à 5, défini dans le tableau disponible en annexe 4.2

On va créer une deuxième échelle pour l’impact sur le projet allant de 1 à 3, défini dans le tableau disponible en annexe 4.3

Et donc grâce aux differentes échelles on peux déterminer un tableau avec les risques et leurs probabilités d'existences ainsi que leurs impacts qui est affiché dans l'annexe 4.4.
...
Les étudiants pourront utiliser ces fonctionnalités. Vous pourrez trouver le schéma des cas d'utilisations en Annexe 4.5.
...
## Annexe 4: Analyse des besoins

## Annexe 4.1: diagramme de gantt represantant l'avancement du projet
...
## Annexe 4.2 : tableau de l'echelle de probabilitée du risque 
...
`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`
## Annexe 4.3 : tableau de l'echelle de l'impact d'un risque sur le projet
...
`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`
## Annexe 4.4: tableau des differents risque avec leur impact
...
## Annexe 4.5: les cas d'utilisations
