...
Cas d'utilisation 29 : modifier le glossaire

- Niveau : Utilisateur

Cas d'utilisation 30 : se connecter en admin au glossaire

- Niveau : Utilisateur
 


Cas d'utilisation 31 : écrire dans les champs de textes l'adresse IP hex-dec

- Niveau : Sous-fonction

Cas d'utilisation 32  : valider hex-dec

- Niveau : Sous-fonction

Cas d'utilisation 33 : Affiche l'adresse IP traduite hex-dec

- Niveau : Sous-fonction
 
Cas d'utilisation 34 : Erreur apparaît si adresse IP hex-dec invalide

- Niveau : Sous-fonction

`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`

Cas d'utilisation 35 : écrire dans les champs de textes l'adresse IP bin-dec

- Niveau : Sous-fonction

Cas d'utilisation 36  : valider bin-dec

- Niveau : Sous-fonction     					 

Cas d'utilisation 37 : Affiche l'adresse IP traduite bin-dec

- Niveau : Sous-fonction
 
Cas d'utilisation 38 : Erreur apparaît si adresse IP bin-dec invalide

- Niveau : Sous-fonction

Cas d'utilisation 39 : écrire dans les champs de texte pour les Sous-réseaux

- Niveau : Sous-fonction

Cas d'utilisation 40 : valider pour les sous-réseaux

- Niveau : Sous-fonction
 
Cas d'utilisation 41 : Affiche les sous-réseaux

- Niveau : Sous-fonction

Cas d'utilisation 42 : Erreur apparaît si adresse IP pour les Sous-réseaux est invalide

- Niveau : Sous-fonction
 
Cas d'utilisation 43 : écrire dans les champs pour le CRC

- Niveau : Sous-fonction

`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`
Cas d'utilisation 44 : valider pour le CRC

- Niveau : Sous-fonction

Cas d'utilisation 45  : Affiche le CRC 

- Niveau : Sous-fonction     					 

Cas d'utilisation 46 : Erreur apparaît si champ du CRC invalide

- Niveau : Sous-fonction
 
Cas d'utilisation 47 : écrire dans les champs de textes pour exécuter une commande réseau

- Niveau : Sous-fonction

Cas d'utilisation 48 :  valider commande réseau

- Niveau : Sous-fonction

Cas d'utilisation 49  : Affiche le résultat de la commande réseau entrée

- Niveau : Sous-fonction

Cas d'utilisation 50 : Erreur apparaît si la commande entrée est invalide	

- Niveau : Sous-fonction

Cas d'utilisation 51 : écrire dans les champs pour ajouter un mot et sa définition au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 52 : écrire dans les champs pour se connecter en admin au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 53 : valider la connexion admin au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 54 : valider la saisie d'un mot pour le glossaire

- Niveau : Sous-fonction

Cas d'utilisation 55 : erreur apparait si mauvais login ou mdp
