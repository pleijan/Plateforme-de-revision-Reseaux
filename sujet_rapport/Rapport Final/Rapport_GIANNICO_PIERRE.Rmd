...
Cas d'utilisation 33 : écrire dans les champs de textes l'adresse IP hex-dec

Niveau : Sous-fonction

Cas d'utilisation 34  : valider hex-dec

- Niveau : Sous-fonction

Cas d'utilisation 35 : écrire dans les champs de textes l'adresse IP hex-dec

- Niveau : Sous-fonction

Cas d'utilisation 36  : valider hex-dec

- Niveau : Sous-fonction

Cas d'utilisation 37 : Affiche l'adresse IP traduite hex-dec

- Niveau : Sous-fonction
 
Cas d'utilisation 38 : Erreur apparaît si adresse IP hex-dec invalide

- Niveau : Sous-fonction

`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`

Cas d'utilisation 39 : écrire dans les champs de textes l'adresse IP bin-dec

- Niveau : Sous-fonction

Cas d'utilisation 40  : valider bin-dec

- Niveau : Sous-fonction     					 

Cas d'utilisation 41 : Affiche l'adresse IP traduite bin-dec

- Niveau : Sous-fonction
 
Cas d'utilisation 42 : Erreur apparaît si adresse IP bin-dec invalide

- Niveau : Sous-fonction

Cas d'utilisation 43 : écrire dans les champs de texte pour les Sous-réseaux

- Niveau : Sous-fonction

Cas d'utilisation 44 : valider pour les sous-réseaux

- Niveau : Sous-fonction
 
Cas d'utilisation 45 : Affiche les sous-réseaux

- Niveau : Sous-fonction

Cas d'utilisation 46 : Erreur apparaît si adresse IP pour les Sous-réseaux est invalide

- Niveau : Sous-fonction
 
Cas d'utilisation 47 : écrire dans les champs pour le CRC

- Niveau : Sous-fonction

`r if(knitr:::pandoc_to() == "latex") {paste("\\newpage")}`
Cas d'utilisation 48 : valider pour le CRC

- Niveau : Sous-fonction

Cas d'utilisation 49  : Affiche le CRC 

- Niveau : Sous-fonction     					 

Cas d'utilisation 50 : Erreur apparaît si champ du CRC invalide

- Niveau : Sous-fonction
 
Cas d'utilisation 51 : écrire dans les champs de textes pour exécuter une commande réseau

- Niveau : Sous-fonction

Cas d'utilisation 52 :  valider commande réseau

- Niveau : Sous-fonction

Cas d'utilisation 53  : Affiche le résultat de la commande réseau entrée

- Niveau : Sous-fonction

Cas d'utilisation 54 : Erreur apparaît si la commande entrée est invalide	

- Niveau : Sous-fonction

Cas d'utilisation 55 : écrire dans les champs pour ajouter un mot et sa définition au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 56 : écrire dans les champs pour se connecter en admin au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 57 : valider la connexion admin au glossaire

- Niveau : Sous-fonction

Cas d'utilisation 58 : valider la saisie d'un mot pour le glossaire

- Niveau : Sous-fonction

Cas d'utilisation 59 : erreur apparait si mauvais login ou mdp
